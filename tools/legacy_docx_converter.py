...
from pdf_to_md.utils.converter_lib import (create_flat_output_structure, sanitize_filename,
                               setup_logging)
...
def validate_docx_path(docx_path):
    """
...
def extract_images_from_docx(doc, images_dir, base_name, context_text="", enable_detailed_alt_text=True):
    """
